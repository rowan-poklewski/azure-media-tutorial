...
conn.on('error', function (err) {
  console.log("Rowan - error");
  console.log(err);
  mongoose.connect(mongodbUri, options);
});

conn.once('open', function () {
  console.log("Rowan - open");
...
var init = function () {
  async.waterfall([
      ...
      function (cb) {
          console.log("Rowan - getRedirectURL");
      api.getRedirectURL(cb);
    },
      function (cb) {
          console.log("Rowan - getMediaProcessors");
      api.getMediaProcessors(cb);
    }
  ], function (err) {
      console.log("Rowan - init error");
    console.log(err);
  });
}
